package me.taras.lib.gameimpl

import me.taras.lib.Game
import me.taras.lib.GameEngine
import me.taras.lib.model.*


class GameLong(firstTurn: Color = Color.ABSENT, turnHistoryWithState: GameHistoryWithState? = null): Game() {
    private val engine = GameEngine(firstTurn, ::initBoardMethod, ::generateTurnsMethod, turnHistoryWithState)
